...
\begin{frame}{Metrics Comparison Chart}
  \begin{center}
    \includegraphics[width=0.85\textwidth]{/Users/kshitijvaidya/Semester8/SpeechProcessing/SpeechProcessing/Final_PPT/Graphs/mt_metrics_comparison.png}
  \end{center}
  \vspace{-0.2cm}
  \small
...
\begin{frame}{TER Comparison}
  \begin{center}
    \includegraphics[width=0.82\textwidth]{/Users/kshitijvaidya/Semester8/SpeechProcessing/SpeechProcessing/Final_PPT/Graphs/mt_ter_comparison.png}
  \end{center}
  \vspace{-0.2cm}
  \small
...
\begin{frame}{Radar Chart — Multi-Metric Profile}
  \begin{center}
    \includegraphics[width=0.72\textwidth]{/Users/kshitijvaidya/Semester8/SpeechProcessing/SpeechProcessing/Final_PPT/Graphs/mt_radar_chart.png}
  \end{center}
  \vspace{-0.2cm}
  \small
...
\begin{frame}{BLEU Score Distribution}
  \begin{center}
    \includegraphics[width=0.85\textwidth]{/Users/kshitijvaidya/Semester8/SpeechProcessing/SpeechProcessing/Final_PPT/Graphs/mt_bleu_distribution.png}
  \end{center}
  \vspace{-0.2cm}
  \small
...
\begin{frame}{Sentence Length vs.\ BLEU Score}
  \begin{center}
    \includegraphics[width=0.85\textwidth]{/Users/kshitijvaidya/Semester8/SpeechProcessing/SpeechProcessing/Final_PPT/Graphs/mt_length_vs_bleu.png}
  \end{center}
  \vspace{-0.2cm}
  \small
