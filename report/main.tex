...
\begin{frame}{Systems Under Evaluation}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{[NMT] MarianMT (Helsinki-NLP)}
        \begin{itemize}
      ...
      \end{block}
      \vspace{0.3cm}
      \begin{block}{[NMT] NLLB-600M (Meta AI)}
        \begin{itemize}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{[NMT] mBART-50 (Meta AI)}
        \begin{itemize}
      ...
      \end{block}
      \vspace{0.3cm}
      \begin{block}{[API] Google Translate (API)}
        \begin{itemize}
...
\begin{frame}{TTS: Plots}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{../TTS/tts_benchmark_results_kaggle_run2/plots/04_robustness_heatmap_en.png}
        \caption{WER Heatmap for English for MMS-TTS and Parler-TTS for different types of sentences.}
    \end{figure}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{../TTS/tts_benchmark_results_kaggle_run3/plots/04_robustness_heatmap_en.png}
